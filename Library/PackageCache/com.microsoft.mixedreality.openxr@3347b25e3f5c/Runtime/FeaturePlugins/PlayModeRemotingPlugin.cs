...
namespace Microsoft.MixedReality.OpenXR.Remoting
{
    ...
    internal class PlayModeRemotingPlugin : OpenXRFeaturePlugin<PlayModeRemotingPlugin>, ISerializationCallbackReceiver
    {
        ...
        protected override void OnSessionStateChange(int oldState, int newState)
        {
            ...
            {
                _ = AppRemoting.TryGetConnectionState(out ConnectionState connectionState, out DisconnectReason disconnectReason);

                Debug.LogWarning($"Cannot establish a connection to Holographic Remoting " +
                    $"on the target with IP Address {RemotingSettings.RemoteHostName}:{RemotingSettings.RemoteHostPort}. " +
